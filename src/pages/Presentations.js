...
const About = () => (
  ...
  >
    <article className="post markdown" id="about">
      ...
      <p>
        I spoke to Secretary of Commerce Raimundo and Congressman Pallone about my research under
        the <a href="https://robotics.rutgers.edu"> SOCRATES NRT</a>. I also gave an address about
        the state of robotics research and federal funding that you can watch above.
      </p>
      <div> <p> </p> </div>
